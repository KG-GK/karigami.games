...
export function Footer({ locale }: { locale: Locale }) {
  ...
  return withWaveText(<footer className="site-footer container">
    <div className="footer-top"><Link className="brand" href={t.home}><Brand /></Link><a href={site.itch} target="_blank" rel="noopener noreferrer">itch.io <ArrowUpRight size={16} /></a></div>
