...
export function siteMetadata(locale: Locale): Metadata {
  ...
  return {
    ...
    icons: {
      icon: [
        { url: "/assets/karigami-favicon-32.png", sizes: "32x32", type: "image/png" },
        { url: "/assets/karigami-favicon-192.png", sizes: "192x192", type: "image/png" },
      ],
      apple: [{ url: "/assets/karigami-apple-touch-icon.png", sizes: "180x180", type: "image/png" }],
    },
  };
}
